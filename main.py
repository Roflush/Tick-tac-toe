...
def game_board(game_map, player=0, row=0, column=0, just_display=False):
    ...
    '''Game_board function passes game_map, player, row, column, and just_disaplay.
       also with in it's body it's passes the game, and player moves. '''
...
while play:
    ...
    while not game_won:
        ...
        if win(game): # After the game is over quit, or replay 
            game_won = True
